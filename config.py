...
BOT_USERNAME = getenv("BOT_USERNAME", "NmSMusikBot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "NmS")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "NmS-Music ")
OWNER_NAME = getenv("OWNER_NAME", "NmS") # isi dengan username kamu tanpa simbol @
